...
class AccountHelpLayer : GJDropDownLayer, GJAccountDelegate, FLAlertLayerProtocol {
    ...
    virtual TodoReturn accountStatusChanged() = win 0x7fcc0, imac 0xcf6d0, m1 0xb8300, ios 0x16b018;
...
class AccountLayer : GJDropDownLayer, GJAccountDelegate, GJAccountBackupDelegate, GJAccountSyncDelegate, FLAlertLayerProtocol {
    ...
    virtual TodoReturn accountStatusChanged() = win 0x7e750, imac 0xcda00, m1 0xb6874, ios 0x169d4c;
...
class AccountLoginLayer : FLAlertLayer, TextInputDelegate, GJAccountLoginDelegate, FLAlertLayerProtocol {
    ...
    virtual TodoReturn loginAccountFinished(int, int) = win 0x7c740, m1 0x3f45bc, imac 0x4870a0, ios 0x87ee8;
    virtual TodoReturn loginAccountFailed(AccountError) = win 0x7c990, imac 0x487430, m1 0x3f493c, ios 0x880f8;
...
class AccountRegisterLayer : FLAlertLayer, TextInputDelegate, GJAccountRegisterDelegate, FLAlertLayerProtocol {
    ...
    virtual TodoReturn registerAccountFinished() = win 0x79c90, imac 0x484040, m1 0x3f1894, ios 0x86168;
    virtual TodoReturn registerAccountFailed(AccountError) = win 0x79eb0, m1 0x3f1a3c, imac 0x4841f0, ios 0x86298;
...
class AchievementCell : TableViewCell {
    ...
    void loadFromDict(cocos2d::CCDictionary*) = win 0xac150, imac 0x230eb0, ios 0x1042ec;
    void updateBGColor(int) = ios 0x1051c8;
...
class AnimatedGameObject : EnhancedGameObject, AnimatedSpriteDelegate, SpritePartDelegate {
    ...
    virtual TodoReturn displayFrameChanged(cocos2d::CCObject*, gd::string) = win 0x48c9d0, imac 0x1a7930, m1 0x169858, ios 0x37d924;
}
...
class AnimatedShopKeeper : CCAnimatedSprite {
    ...
    void playReactAnimation() = win 0x2a8520;
...
class AudioAssetsBrowser : FLAlertLayer, TableViewCellDelegate, MusicDownloadDelegate {
    ...
    virtual TodoReturn getCellDelegateType() = m1 0x6b1d44, imac 0x79f990, ios 0x1d3070;
...
class BoomScrollLayer : cocos2d::CCLayer {
    ...
    void selectPage(int);
    void setDotScale(float scale) = win inline, m1 0x321608 {
    ...
    void updatePages() = win 0x3d840, m1 0x3209f4;
...
class CCBlockLayer : cocos2d::CCLayerColor {
    ...
    void decrementForcePrio() = m1 0x461924, ios 0x8a5a4;
...
class CCMenuItemSpriteExtra : cocos2d::CCMenuItemSprite {
    ...
    static CCMenuItemSpriteExtra* create(cocos2d::CCNode* sprite, cocos2d::CCNode* disabledSprite, cocos2d::CCObject* target, cocos2d::SEL_MenuHandler callback) = win 0x44b40, imac 0x264b80, m1 0x2105c0, ios 0x214364;
...
class CCMenuItemToggler : cocos2d::CCMenuItem {
    ...
    static CCMenuItemToggler* create(cocos2d::CCNode*, cocos2d::CCNode*, cocos2d::CCObject*, cocos2d::SEL_MenuHandler) = win 0x451e0, imac 0x59c70, m1 0x4f880, ios 0x19452C;
    ...
    bool init(cocos2d::CCNode* off, cocos2d::CCNode* on, cocos2d::CCObject* target, cocos2d::SEL_MenuHandler callback) = win inline, imac 0x59d40, m1 0x4f964, ios 0x1945fc /* ? */ {
    ...
    void setSizeMult(float mult) = win inline, m1 0x4fe70, ios 0x1948ac {
        m_offButton->setSizeMult(mult);
        m_onButton->setSizeMult(mult);

        this->toggle(this->m_toggled);
    }
    void toggle(bool) = win 0x455c0, imac 0x5a120, m1 0x4fd98, ios 0x1947d4; // ?
...
class CCTextInputNode : cocos2d::CCLayer, cocos2d::CCIMEDelegate, cocos2d::CCTextFieldDelegate {
    ...
    void updateBlinkLabelToChar(int) = win 0x4fe20, imac 0x9eb40, m1 0x9141c, ios 0x1707c0;
...
class ChallengeNode : cocos2d::CCNode {
    ...
    bool init(GJChallengeItem* challengeItem, ChallengesPage* challengesPage, bool isNew) = win 0x86ce0, imac 0x38b860, m1 0x31ad04, ios 0x37094;
...
class ChallengesPage : FLAlertLayer, FLAlertLayerProtocol, GJChallengeDelegate, CurrencyRewardDelegate {
    ...
    ChallengeNode* createChallengeNode(int number, bool skipAnimation, float animLength, bool isNew) = win 0x86090, imac 0x38abe0, m1 0x31a168, ios 0x36770;
...
class CharacterColorPage : FLAlertLayer {
    ...
    void createColorMenu() = win 0x88e50, m1 0x56ffac, ios 0x12cc88;
...
class ColorChannelSprite : cocos2d::CCSprite {
    ...
    static ColorChannelSprite* create() = win 0x2515d0, m1 0x2685c0, imac 0x2c46d0, ios 0x106c8; // ?
    ...
    void updateOpacity(float alpha) = win 0x251870, imac 0x2c4950, m1 0x26881c, ios 0x10910;
...
class CommentCell : TableViewCell, LikeItemDelegate, FLAlertLayerProtocol {
    ...
    void loadFromComment(GJComment*) = win 0xb5480, m1 0x1e5f14, imac 0x235d50, ios 0x108cb0;
    ...
    void updateBGColor(int) = ios 0x10a674;
...
class CurrencySprite : CCSpritePlus {
    ...
    bool init(CurrencySpriteType, bool) = win 0xa2cd0, m1 0x6a74c0;
...
class CustomizeObjectLayer : FLAlertLayer, TextInputDelegate, HSVWidgetDelegate, ColorSelectDelegate, ColorSetupDelegate {
    ...
    bool init(GameObject*, cocos2d::CCArray*) = win 0xa4d00, imac 0x1e3120, m1 0x19a9d0, ios 0x50fa4;
    ...
    void toggleVisible() = win 0xa8af0, imac 0x1e7220, m1 0x19e668, ios 0x542c0;
...
class CustomListView : BoomListView {
    ...
    float getCellHeight(BoomListType) = imac 0x22fd60, ios 0x103e9c;
    void reloadAll() = win 0xabc90, imac 0x23bfe0, m1 0x1ebe10, ios 0x10e7b0;
...
class CustomSFXCell : TableViewCell, CustomSFXDelegate {
    ...
    virtual TodoReturn getActiveSFXID() = win 0xb4110, m1 0x1f1854, imac 0x242240, ios 0x1131d8;
}
...
class CustomSFXWidget : cocos2d::CCNode, MusicDownloadDelegate, FLAlertLayerProtocol {
    ...
    bool init(SFXInfoObject*, CustomSFXDelegate*, bool, bool, bool, bool, bool) = imac 0x5ca7d0;
    ...
    TodoReturn updateSFXInfo() = imac 0x5cbcc0;
...
class CustomSongCell : TableViewCell, CustomSongDelegate {
    ...
    virtual TodoReturn songIDChanged(int) = win 0xb40d0, imac 0x241e90, m1 0x1f15f4, ios 0x112fc4;
    virtual TodoReturn getActiveSongID() = m1 0x1f1650, imac 0x241f10, ios 0x113020;
    virtual TodoReturn getSongFileName() = win 0xb4130, m1 0x1f1688, imac 0x241f70, ios 0x113058;
...
class CustomSongLayer : FLAlertLayer, TextInputDelegate, GJDropDownLayerDelegate, MusicBrowserDelegate {
    ...
    bool init(CustomSongDelegate*) = win 0xc1f00, m1 0x1b83c0;
...
class DailyLevelNode : cocos2d::CCNode, FLAlertLayerProtocol {
    ...
    bool init(GJGameLevel*, DailyLevelPage*, bool) = win 0xd0c90, imac 0x2209a0, m1 0x1d3884, ios 0x1bcd9c;
...
class DailyLevelPage : FLAlertLayer, FLAlertLayerProtocol, GJDailyLevelDelegate, LevelDownloadDelegate {
    ...
    bool init(GJTimedLevelType) = win 0xcd110, imac 0x21e440, m1 0x1d0ebc, ios 0x1baf38;
...
class DemonInfoPopup : FLAlertLayer {
    ...
    bool init(int easyClassic, int mediumClassic, int hardClassic, int insaneClassic, int extremeClassic, int easyPlatformer, int mediumPlatformer, int hardPlatformer, int insanePlatformer, int extremePlatformer, int weekly, int gauntlet) = win 0x3afdf0, imac 0x7abc10, m1 0x6bd34c, ios 0x1a02a8;
    void onClose(cocos2d::CCObject* sender);
...
class DialogLayer : cocos2d::CCLayerColor, TextAreaDelegate {
    ...
    virtual TodoReturn fadeInTextFinished(TextArea*) = win 0xd2bd0, m1 0x3409fc, imac 0x3b5420, ios 0x8b548;
...
class EditLevelLayer : cocos2d::CCLayer, TextInputDelegate, FLAlertLayerProtocol, UploadActionDelegate, UploadPopupDelegate, SetIDPopupDelegate {
    ...
    void onShare(cocos2d::CCObject* sender) = win 0xd6f20, ios 0xed54c;
    ...
    void setupLevelInfo() = win 0xd5720, m1 0x1a1540;
...
class EditorPauseLayer : CCBlockLayer, FLAlertLayerProtocol {
    ...
    bool init(LevelEditorLayer*) = win 0xd8990, imac 0x1eb720, m1 0x228bbc, ios 0x394950;
    ...
    void onResetUnusedColors(cocos2d::CCObject* sender) = imac 0x281e30;
...
class EditorUI : cocos2d::CCLayer, FLAlertLayerProtocol, ColorSelectDelegate, GJRotationControlDelegate, GJScaleControlDelegate, GJTransformControlDelegate, MusicDownloadDelegate, SetIDPopupDelegate {
    ...
    void dynamicGroupUpdate(bool) = win 0x117000, imac 0x44e10;
    ...
    TodoReturn editHSV();
    void editObject(cocos2d::CCObject*) = win 0x11a510;
    ...
    cocos2d::CCArray* pasteObjects(gd::string, bool, bool) = win 0x111d10;
    ...
    void updateDeleteButtons() = win 0xe5fb0, m1 0x31c94;
    ...
    virtual TodoReturn getUI() = win 0xdd8f0, imac 0x546c0, m1 0x8fb0, ios 0xd590;
    ...
    virtual TodoReturn getTransformNode() = win 0xdd900, m1 0x4b658, imac 0x546d0, ios 0x3f4498;
...
class EditTriggersPopup : SetupTriggerPopup {
    ...
    bool init(EffectGameObject*, cocos2d::CCArray*) = win 0x2875b0, m1 0x231cd4;
...
class EndPortalObject : GameObject {
    ...
    void triggerObject(GJBaseGameLayer*) = m1 0x318dcc, ios 0x3f6a50;
...
class FMODAudioEngine : cocos2d::CCNode {
    ...
    void fadeInMusic(float, int) = win 0x5c3c0, imac 0x3d4f80, ios 0x1406b8;
    TodoReturn fadeMusic(float, int, float, float);
    float fadeOutMusic(float, int) = win 0x5c500, m1 0x35d940, imac 0x3d7e20, ios 0x141e24;
    ...
    float getBackgroundMusicVolume() = win inline, imac 0x3d4880, m1 0x35ad68, ios 0x140278 {
    ...
    void pauseAllMusic(bool) = imac 0x3d4930, m1 0x35ade0, ios 0x1402f0;
    ...
    void stop();
    void stopAllEffects() = win 0x598b0, m1 0x353c3c, imac 0x3cb410, ios 0x13bc58;
    void stopAllMusic(bool) = imac 0x3cbbf0, m1 0x353f28, ios 0x13bd04;
...
class FollowRewardPage : FLAlertLayer, FLAlertLayerProtocol, GameRateDelegate, RewardedVideoDelegate {
    ...
    void onSpecialItem(cocos2d::CCObject* sender) = win 0x13a340, m1 0x38a858;
...
class FRequestProfilePage : FLAlertLayer, FLAlertLayerProtocol, UploadActionDelegate, UploadPopupDelegate, FriendRequestDelegate {
    ...
    virtual TodoReturn loadFRequestsFinished(cocos2d::CCArray*, char const*) = win 0x13dbd0, imac 0x77b7e0, m1 0x690608, ios 0x1b95c0;
    virtual TodoReturn loadFRequestsFailed(char const*, GJErrorCode) = win 0x13dc50, imac 0x77b8d0, m1 0x690714, ios 0x1b9644;
    virtual void setupPageInfo(gd::string, char const*) = win 0x13dcf0, imac 0x77ba20, m1 0x690874, ios 0x1b9714;
    virtual TodoReturn forceReloadRequests(bool) = win 0x13dcd0, imac 0x77b9e0, m1 0x690840, ios 0x1b96e0;
}
...
class GameLevelManager : cocos2d::CCNode {
    ...
    GJLevelList* createNewLevelList() = win 0x1432b0, m1 0x474704, ios 0x96a04;
    ...
    void getAccountComments(int accountID, int page, int total) = imac 0x539a30;
    int getActiveDailyID(GJTimedLevelType) = imac 0x5439d0;
    ...
    void getLevelLeaderboard(GJGameLevel*, LevelLeaderboardType, LevelLeaderboardMode) = win 0x155ff0, imac 0x13bd80;
    ...
    cocos2d::CCArray* getStoredOnlineLevels(char const*) = win 0x147780, imac 0x5223c0, m1 0x47e2d8, ios 0x9d020;
    ...
    bool isFollowingUser(int) = win 0x148840, imac 0x523fe0, m1 0x47fda8, ios 0x9df80;
    ...
    void onGetGJChallengesCompleted(gd::string response, gd::string tag) = imac 0x510b00;
    ...
    void onRestoreItemsCompleted(gd::string response, gd::string tag) = imac 0x50cc20;
    ...
    void onUploadCommentCompleted(gd::string response, gd::string tag) = win 0x15bde0, imac 0x50b830;
    ...
    void saveLevel(GJGameLevel*) = win 0x146d40, imac 0x521650;
    ...
    gd::string writeSpecialFilters(GJSearchObject*) = win 0x14b8b0, imac 0x529260;
...
class GameManager : GManager {
    ...
    static GameManager* sharedState() = win 0x178480, imac 0x363400, m1 0x2f60ec, ios 0x311de4; // ?

    TodoReturn accountStatusChanged();
    int activeIconForType(IconType) = win 0x17ea70, imac 0x36d480, m1 0x2feb3c, ios 0x31781c;
    ...
    int countForType(IconType) = win 0x17ebe0, m1 0x2febfc, imac 0x36d6f0, ios 0x3178fc;
    ...
    const char* getBGTexture(int id) = win inline, imac 0x370460, m1 0x3017dc, ios 0x318e30 {
    ...
    void getFontFile(int) = imac 0x36fa00, ios 0x318378;
    TodoReturn getFontTexture(int);

    GJBaseGameLayer* getGameLayer() {
        return m_gameLayer;
    }
    bool getGameVariable(char const*) = win 0x1800f0, imac 0x363b40, m1 0x2f6894, ios 0x312374; // ?
    ...
    void loadDeathEffect(int id) = win inline, imac 0x36fac0, m1 0x300de4, ios 0x318448 {
        if (id < 1) id = 1;
        if (id > 19) id = 20;
    ...
    void toggleGameVariable(char const*) = win 0x180270, imac 0x3707d0, m1 0x301b54, ios 0x319068;
    ...
    IconType unlockTypeToIconType(int) = win 0x1796e0, imac 0x364ba0, m1 0x2f7528, ios 0x312d64;
...
class GameObject : CCSpritePlus {
    ...
    static GameObject* createWithKey(int) = win 0x188850, imac 0x585720, m1 0x4d73bc, ios 0x253594;
    static GameObject* objectFromVector(gd::vector<gd::string>&, gd::vector<void*>&, GJBaseGameLayer*, bool) = win 0x19a260, m1 0x4e2090;

    void addColorSprite(gd::string) = win 0x18b830;
...
class GameOptionsLayer : GJOptionsLayer {
    ...
    void showPracticeMusicSyncUnlockInfo() = win 0x298380;
...
class GameStatsManager : cocos2d::CCNode {
    ...
    void checkCoinAchievement(GJGameLevel*) = win 0x1da830, imac 0x6c8d0, m1 0x60414, ios 0x33052c;
    ...
    GJRewardItem* completedDailyLevel(GJGameLevel*) = win 0x1dfe10;
    void completedDemonLevel(GJGameLevel*) = m1 0x613f8;
    TodoReturn completedLevel(GJGameLevel*) = imac 0x6d6b0, ios 0x330d54;
    ...
    GJChallengeItem* getChallenge(int) = win 0x1dee70;
    TodoReturn getChallengeKey(GJChallengeItem*);
    int getCollectedCoinsForLevel(GJGameLevel*) = win 0x1dabd0;
    cocos2d::CCArray* getCompletedMapPacks() = win 0x1dc180, m1 0x6230c;
    ...
    int getItemUnlockState(int itemID, UnlockType unlockType) = win 0x1e2b30, m1 0x6a898, imac 0x77010, ios 0x336148;
    ...
    GJChallengeItem* getQueuedChallenge(int) = win 0x1def40;
    ...
    bool hasCompletedLevel(GJGameLevel* level) = win inline, imac 0x6d280, m1 0x60e04, ios 0x330af4 {
    ...
    TodoReturn processChallengeQueue(int) = win 0x1df950, m1 0x67160;
    ...
    TodoReturn resetSpecialStatAchievements() = imac 0x76aa0;
...
class GameToolbox {
    ...
    static void addRThumbScrollButton(cocos2d::CCLayer*) = win 0x650f0, m1 0x43fa2c, imac 0x4dc960, ios 0x48380;
    ...
    static void fast_srand(uint64_t) = imac 0x4dea30, ios 0x49534;
...
class GauntletNode : cocos2d::CCNode {
    ...
    static gd::string frameForType(GauntletType) = win 0x1f9030;
    static gd::string nameForType(GauntletType) = win 0x1fa250;
...
class GauntletSelectLayer : cocos2d::CCLayer, BoomScrollLayerDelegate, LevelManagerDelegate {
    ...
    void setupGauntlets() = win 0x1f6790, m1 0x4b1f30, imac 0x55b9a0, ios 0x1c10e4;
    void unblockPlay();
    void updateArrows();
...
class GJAccountManager : cocos2d::CCNode {
    ...
    bool backupAccount(gd::string) = win 0x1fc8f0;
    void dataLoaded(DS_Dictionary*);
    void encodeDataTo(DS_Dictionary*) = imac 0xd46d0, m1 0xbcd20;
    void firstSetup();
    bool getAccountBackupURL() = win 0x1fc2d0;
    bool getAccountSyncURL() = win 0x1fd230;
    cocos2d::CCObject* getDLObject(char const*);
    gd::string getShaPassword(gd::string) = win 0x1feee0;
    void handleIt(bool, gd::string, gd::string, GJHttpType) = m1 0xb8918;
    void handleItDelayed(bool, gd::string, gd::string, GJHttpType);
    void handleItND(cocos2d::CCNode*, void*);
    bool isDLActive(char const* tag);
...
class GJBaseGameLayer : cocos2d::CCLayer, TriggerEffectDelegate {
    ...
    TodoReturn addGuideArt(GameObject*) = imac 0x151740;
    ...
    void bumpPlayer(PlayerObject*, EffectGameObject*) = win 0x2124f0, imac 0x117ce0, m1 0xf6b04, ios 0x1eab1c;
    ...
    TodoReturn checkCameraLimitAfterTeleport(PlayerObject*, float) = win 0x2340b0, imac 0x110df0, m1 0xf0a1c, ios 0x1e5b9c;
    ...
    void createBackground(int) = win 0x2064e0, imac 0x1030e0, m1 0xe4ed4, ios 0x1dea24;
    void createGroundLayer(int, int) = win 0x206920, imac 0x103660, m1 0xe5410, ios 0x1def60;
    void createMiddleground(int) = win 0x2067a0, imac 0x103870, m1 0xe55f4, ios 0x1df0e8;
    TodoReturn createNewKeyframeAnim();
    ...
    TodoReturn getCameraEdgeValue(int) = imac 0x13f630, ios 0x1ff2e4;
    ...
    TodoReturn gravBumpPlayer(PlayerObject*, EffectGameObject*) = imac 0x117ef0, m1 0xf6d28, ios 0x1eac54;
    ...
    void playExitDualEffect(PlayerObject*) = win 0x2119a0, ios 0x1eb9b0;
    ...
    void preResumeGame() = imac 0x141dd0, ios 0x200998;
    TodoReturn preUpdateVisibility(float);
    void processActivatedAudioTriggers(float) = win 0x23d3e0, imac 0x14f3a0, ios 0x208724;
    ...
    void processAreaMoveGroupAction(cocos2d::CCArray*, EnterEffectInstance*, cocos2d::CCPoint, int, int, int, int, int, bool, bool) = win 0x2251f0;
    ...
    void resetActiveEnterEffects() = win 0x209060, imac 0x10d800, m1 0xed248, ios 0x1e3a30;
    ...
    void setupLevelStart(LevelSettingsObject*) = win 0x20cd60, imac 0x112f20, m1 0xf28b8, ios 0x1e73bc;
    ...
    TodoReturn shouldExitHackedLevel() = imac 0x102b90, ios 0x1de628;
    ...
    GameObject* tryGetMainObject(int) = win 0x21f170, imac 0x11a040, m1 0xf8cc4, ios 0x1ec2b4;
    ...
    void updateCameraMode(EffectGameObject* obj, bool updateDual) = win inline, imac 0x114180, ios 0x1e7dc8 {
    ...
    void updateDualGround(PlayerObject*, int, bool, float) = win 0x20dcc0, imac 0x113e30, m1 0xf365c, ios 0x1e7b4c;
    ...
    void updateStaticCameraPos(cocos2d::CCPoint pos, bool staticX, bool staticY, bool followOrSmoothEase, float time, int easingType, float easingRate) = win 0x238ca0, imac 0x114990, m1 0xf40c8, ios 0x1e8330;
...
class GJCommentListLayer : cocos2d::CCLayerColor {
    ...
    static GJCommentListLayer* create(BoomListView* listView, char const* title, cocos2d::ccColor4B color, float width, float height, bool blueBorder) = win 0x28a320, imac 0x28c900, m1 0x235434, ios 0x2d519c;

    bool init(BoomListView* listView, char const* title, cocos2d::ccColor4B color, float width, float height, bool blueBorder) = win 0x28a440, imac 0x28ca10, m1 0x23552c, ios 0x2d5280;
...
class GJDifficultySprite : cocos2d::CCSprite {
    ...
    void updateDifficultyFrame(int, GJDifficultyName) = win 0x29da90, imac 0x2a37c0, m1 0x24a5b0, ios 0x2e5534;
    void updateFeatureState(GJFeatureState) = win 0x29dbb0, imac 0x2a3940, m1 0x24a728, ios 0x2e56ac;
    void updateFeatureStateFromLevel(GJGameLevel*) = m1 0x24a6f0, ios 0x2e5674;
...
class GJDropDownLayer : cocos2d::CCLayerColor {
    ...
    bool init(char const*, float, bool) = win 0x24feb0, imac 0x5cfdd0, m1 0x503f2c, ios 0x3aa920;
    bool init(char const* title) = win inline, imac 0x5d01f0, ios 0x3aad1c {
...
class GJEffectManager : cocos2d::CCNode {
    ...
    ColorAction* getColorAction(int) = win 0x254870, imac 0x2ca1e0, m1 0x26d3c4, ios 0x12b80;
    ...
    void updateEffects(float) = win 0x254b10, imac 0x2cb6a0, m1 0x26e5bc, ios 0x137b4;
...
class GJFollowCommandLayer : SetupTriggerPopup {
    ...
    bool init(EffectGameObject*, cocos2d::CCArray*) = win 0x268e30;
...
class GJGameLevel : cocos2d::CCNode {
    ...
    void saveNewScore(int, int) = ios 0xb0314;
    void savePercentage(int percent, bool isPracticeMode, int clicks, int attempts, bool isChkValid) = win 0x169db0, m1 0x49e170, imac 0x545320, ios 0xafc44;
...
class GJGameLoadingLayer : cocos2d::CCLayer {
    ...
    static GJGameLoadingLayer* create(GJGameLevel* level, bool editor) = imac 0x1546e0, ios 0x20b54c;
    static GJGameLoadingLayer* transitionToLoadingLayer(GJGameLevel* level, bool editor) = win 0x242890, ios 0x20b4c0;

    void gameLayerDidUnload();
    bool init(GJGameLevel* level, bool editor) = imac 0x154a40, ios 0x20b698;
...
class GJGarageLayer : cocos2d::CCLayer, TextInputDelegate, FLAlertLayerProtocol, GameRateDelegate, ListButtonBarDelegate, DialogDelegate, CharacterColorDelegate, RewardedVideoDelegate {
    ...
    GJGarageLayer() = win inline, ios 0x309620 {
    ...
    static GJGarageLayer* node() = win inline, ios 0x301d84 {
    ...
    static cocos2d::CCScene* scene() = win 0x26b5b0, imac 0x3559f0, ios 0x301d40;
    ...
    cocos2d::CCArray* getItems(int, int, IconType, int) = imac 0x35a440, ios 0x3058b8;
    ...
    void onInfo(cocos2d::CCObject* sender) = win 0x26d190;
    void onNavigate(cocos2d::CCObject* sender) = win 0x26e690, imac 0x359d50, m1 0x2ed4c8, ios 0x305378;
    ...
    void selectTab(IconType) = win 0x26e6f0, imac 0x3595c0, m1 0x2ecd78, ios 0x304d0c;
    void setupIconSelect() = win 0x26d930, ios 0x303b74;
    void setupPage(int, IconType) = win 0x26e7b0, imac 0x359700, m1 0x2ecea8, ios 0x304de4;
    void setupSpecialPage() = imac 0x359d80, m1 0x2ed500, ios 0x3053b0;
...
class GJGroundLayer : cocos2d::CCLayer {
    ...
    static GJGroundLayer* create(int, int) = win 0x276870, imac 0x5d2760, ios 0x2fddc;

    void createLine(int) = win 0x277120;
    ...
    void updateGround01Color(cocos2d::ccColor3B) = ios 0x30630;
    void updateGround02Color(cocos2d::ccColor3B) = ios 0x3075c;
...
class GJItemIcon : cocos2d::CCSprite {
    ...
    static GJItemIcon* createBrowserItem(UnlockType unlockType, int itemID) = win 0x273070, imac 0x35a800, ios 0x307bd8;
    static GJItemIcon* createStoreItem(UnlockType, int, bool, cocos2d::ccColor3B) = win 0x272f40, imac 0x35d910, m1 0x2f0b84;

    static float scaleForType(UnlockType) = win 0x273d90, imac 0x35a830, ios 0x305b68;
    ...
    bool init(UnlockType, int, cocos2d::ccColor3B, cocos2d::ccColor3B, bool, bool, bool, cocos2d::ccColor3B) = win 0x273190, m1 0x2f0cb0;
...
class GJLevelList : cocos2d::CCNode {
    ...
    TodoReturn createWithCoder(DS_Dictionary*) = m1 0x4a4f38, ios 0xb533c;
    void dataLoaded(DS_Dictionary*) = win 0x174cd0, imac 0x54cef0, m1 0x4a4f68, ios 0xb536c;
...
class GJLevelScoreCell : TableViewCell {
    ...
    void loadFromScore(GJUserScore*) = win 0xb93d0, imac 0x238d60;
...
class GJListLayer : cocos2d::CCLayerColor {
    ...
    bool init(BoomListView*, char const*, cocos2d::ccColor4B, float, float, int) = win 0x277fa0, imac 0x5b9f10, m1 0x4f0054, ios 0x839d0;
...
class GJMessagePopup : FLAlertLayer, UploadActionDelegate, UploadPopupDelegate, FLAlertLayerProtocol, DownloadMessageDelegate {
    ...
    void loadFromGJMessage(GJUserMessage*) = win 0x290760, m1 0x23c0a8;
    ...
    virtual TodoReturn downloadMessageFinished(GJUserMessage*) = win 0x2914b0, imac 0x294d00, m1 0x23cecc, ios 0x2db3f0;
    virtual TodoReturn downloadMessageFailed(int) = win 0x291500, imac 0x294dc0, m1 0x23cfa4, ios 0x2db464;
...
class GJMoreGamesLayer : GJDropDownLayer {
    ...
    static GJMoreGamesLayer* create() = win 0x278610;
...
class GJPathPage : FLAlertLayer, FLAlertLayerProtocol, GJPurchaseDelegate {
    ...
    bool init(int, GJPathsLayer*) = m1 0x285220;
...
class GJRotateCommandLayer : SetupTriggerPopup {
    ...
    virtual TodoReturn valuePopupClosed(ConfigureValuePopup*, float) = m1 0x7148, imac 0x4af0;
}
...
class GJScoreCell : TableViewCell, FLAlertLayerProtocol {
    ...
    void loadFromScore(GJUserScore*) = win 0xb7c80, m1 0x1e7b58, imac 0x237bc0, ios 0x10a7a0;
...
class GJSearchObject : cocos2d::CCNode {
    ...
    static GJSearchObject* create(SearchType searchType) = win 0x1716f0, imac 0x54a4c0, m1 0x4a2b10, ios 0xb8ec8;
...
class GJShopLayer : cocos2d::CCLayer, GJPurchaseDelegate, DialogDelegate, RewardedVideoDelegate {
    ...
    void showCantAffordMessage(GJStoreItem*);
    void showReactMessage() = win 0x2a58e0;
...
class GJUserCell : TableViewCell, FLAlertLayerProtocol, UploadPopupDelegate, UploadActionDelegate {
    ...
    void loadFromScore(GJUserScore*) = win 0xb9f70, imac 0x239a60, ios 0x10c530;
...
class GooglePlayManager : cocos2d::CCNode {
    ...
    static GooglePlayManager* sharedState() = ios 0x458d8;
...
class InfoLayer : FLAlertLayer, LevelCommentDelegate, CommentUploadDelegate, FLAlertLayerProtocol {
    ...
    bool init(GJGameLevel*, GJUserScore*, GJLevelList*) = win 0x2b33a0, m1 0x6ab874, imac 0x798e00, ios 0x34f334;
    bool isCorrect(char const*);
    ...
    void onLevelInfo(cocos2d::CCObject* sender) = win 0x2b64e0;
    ...
    void setupCommentsBrowser(cocos2d::CCArray*) = win 0x2b71f0, imac 0x79c0e0, m1 0x6ae750, ios 0x351b78;
...
class LeaderboardsLayer : cocos2d::CCLayer, LeaderboardManagerDelegate, FLAlertLayerProtocol {
    ...
    bool init(LeaderboardState) = win 0x2b9cd0, m1 0x45c030, imac 0x4fc4a0, ios 0x3a91e8;
    bool isCorrect(char const*);
...
class LevelAreaInnerLayer : cocos2d::CCLayer, DialogDelegate {
    ...
    static LevelAreaInnerLayer* create(bool) = imac 0x267c20, ios 0x345028;
    static cocos2d::CCScene* scene(bool) = win 0x2be1d0, imac 0x267950;

    bool init(bool) = win 0x2be2e0, m1 0x2135d4, imac 0x267d00, ios 0x3450dc;
    void onBack(cocos2d::CCObject* sender) = win 0x2c04a0, ios 0x345c0c;
    void onDoor(cocos2d::CCObject* sender) = win 0x2bffd0, imac 0x268bd0, m1 0x2143f8, ios 0x345c64;
    void onInfo(cocos2d::CCObject* sender);
    ...
    virtual void onExit() = m1 0x21533c, imac 0x269ba0, ios 0x346768;
}
...
class LevelAreaLayer : cocos2d::CCLayer, DialogDelegate {
    ...
    virtual bool init() = imac 0x2658d0, m1 0x2111e8, ios 0x34353c;
    ...
    virtual void onExit() = m1 0x2133a4, imac 0x267a60, ios 0x344f94;
}
...
class LevelBrowserLayer : cocos2d::CCLayerColor, LevelManagerDelegate, FLAlertLayerProtocol, SetIDPopupDelegate, SetTextPopupDelegate, TableViewCellDelegate, ShareCommentDelegate {
    ...
    static LevelBrowserLayer* create(GJSearchObject*) = win 0x2c09f0, imac 0x478170, m1 0x3e6590, ios 0x40c184;
    static cocos2d::CCScene* scene(GJSearchObject* search) = win 0x2c09a0, imac 0x478130, m1 0x3e6544, ios 0x40c138; // ?
    ...
    void onHelp(cocos2d::CCObject* sender);
    void onInfo(cocos2d::CCObject* sender) = win 0x2c4df0, imac 0x47ae20;
    ...
    void onSearch(cocos2d::CCObject* sender) = win 0x2c6840;
...
class LevelCell : TableViewCell {
    ...
    void loadCustomLevelCell() = win 0xadb20, imac 0x23d540, m1 0x1ed1f0, ios 0x10f6e4;
    void loadFromLevel(GJGameLevel*) = win 0xad940, imac 0x232d00, m1 0x1e2d4c, ios 0x105c2c;
...
class LevelInfoLayer : cocos2d::CCLayer, LevelDownloadDelegate, LevelUpdateDelegate, RateLevelDelegate, LikeItemDelegate, FLAlertLayerProtocol, LevelDeleteDelegate, NumberInputDelegate, SetIDPopupDelegate, TableViewCellDelegate {
    ...
    void onRate(cocos2d::CCObject* sender) = win 0x2e96e0, m1 0x256d54;
...
class LevelLeaderboard : FLAlertLayer, LeaderboardManagerDelegate, FLAlertLayerProtocol {
    ...
    TodoReturn setupLeaderboard(cocos2d::CCArray*) = m1 0x351800;
...
class LevelPage : cocos2d::CCLayer, DialogDelegate {
    ...
    void onTheTower(cocos2d::CCObject* sender) = win 0x307150, m1 0x39e83c;
...
class LevelSelectLayer : cocos2d::CCLayer, BoomScrollLayerDelegate, DynamicScrollDelegate {
    ...
    static LevelSelectLayer* create(int page) = win inline, imac 0x41f070, ios 0x3f97fc {
    ...
    static cocos2d::CCScene* scene(int) = win 0x303710, imac 0x41ef50, ios 0x3f97b0;
    ...
    void onBack(cocos2d::CCObject* sender) = win 0x304e80;
...
class LevelSettingsObject : cocos2d::CCNode {
    ...
    static LevelSettingsObject* create() = win 0x2dd1f0, ios 0x357b18;
...
class LevelTools {
    ...
    static GJGameLevel* getLevel(int, bool) = win 0x310320, imac 0x4e8620;
    ...
    static gd::string nameForArtist(int) = win 0x3143f0;
    static gd::string ngURLForArtist(int) = win 0x315a10;
...
class ListButtonBar : cocos2d::CCNode {
    ...
    static ListButtonBar* create(cocos2d::CCArray*, cocos2d::CCPoint, int, int, float, float, float, float, int) = win 0x6ad70, imac 0x3de040, m1 0x360e74, ios 0x16b2d8;
...
class LoadingLayer : cocos2d::CCLayer {
    ...
    const char* getLoadingString() = win 0x31a930, imac 0x38fcf0;
    bool init(bool) = win 0x319600, imac 0x38f560, m1 0x31e314, ios 0x1D6E44;
    void loadAssets() = win 0x319ea0, imac 0x38fdb0, m1 0x31eb80, ios 0x1d75f0;
...
class LocalLevelManager : GManager {
    ...
    gd::string getMainLevelString(int) = win 0x31b3d0, ios 0x1c9594;
    ...
    TodoReturn updateLevelRevision() = win 0x31b640;
...
class MapPackCell : TableViewCell {
    ...
    void loadFromMapPack(GJMapPack*) = win 0xb14e0, imac 0x232f20, m1 0x1e2f88, ios 0x105e40;
    ...
    void updateBGColor(int idx) = win inline, ios 0x10690c {
...
class MenuGameLayer : cocos2d::CCLayer {
    ...
    static MenuGameLayer* create() = win inline, ios 0x39325c {
    ...
    cocos2d::ccColor3B getBGColor(int) = win 0x31cde0, imac 0x4e6b60, m1 0x448bc0, ios 0x3936e8;
    ...
    void updateColor(float) = win 0x31cc90, imac 0x4e6e60, m1 0x448f34, ios 0x3939d4;
    void updateColors() = imac 0x4e7840, m1 0x449788, ios 0x3940dc;
...
class MenuLayer : cocos2d::CCLayer, FLAlertLayerProtocol, GooglePlayDelegate {
    ...
    void onCreator(cocos2d::CCObject* sender) = win 0x320e70, ios 0x266990;
    ...
    void onGarage(cocos2d::CCObject* sender) = win 0x320f00, m1 0x30e9b0, ios 0x266938;
    ...
    void onYouTube(cocos2d::CCObject* sender);
    void openOptions(bool videoOptions) = win 0x320bd0, m1 0x30f360, ios 0x2670e0;
    void showGCQuestion() = m1 0x30f144;
    ...
    void willClose() = win 0x3211f0, m1 0x30d274, ios 0x26548c;
...
class MessagesProfilePage : FLAlertLayer, FLAlertLayerProtocol, UploadActionDelegate, UploadPopupDelegate, MessageListDelegate {
    ...
    void deleteSelected() = win 0x3227d0, m1 0x1cfac8;
    bool init(bool) = win 0x321850, m1 0x1ce900;
    bool isCorrect(char const*);
...
class MoreOptionsLayer : FLAlertLayer, TextInputDelegate, GooglePlayDelegate, GJDropDownLayerDelegate {
    ...
    void onFMODDebug(cocos2d::CCObject* sender) = win 0x3606a0, m1 0x69b39c;
    ...
    void onPrevPage(cocos2d::CCObject* sender);
    void onSongBrowser(cocos2d::CCObject* sender) = win 0x360630, m1 0x69b344;
...
class MoreSearchLayer : FLAlertLayer, TextInputDelegate {
    ...
    void onInfo(cocos2d::CCObject* sender) = win 0x3025e0, m1 0x54423c;
    ...
    void updateAudioLabel() = win 0x3019a0, m1 0x5444e0;
...
class MPLobbyLayer : cocos2d::CCLayer, GJMPDelegate, UploadPopupDelegate, UploadActionDelegate, FLAlertLayerProtocol, TextInputDelegate {
    ...
    virtual TodoReturn joinLobbyFinished(int) = imac 0x480fa0, m1 0x3eef10;
    virtual TodoReturn joinLobbyFailed(int, GJMPErrorCode) = imac 0x481450, m1 0x3ef334;
    virtual TodoReturn updateComments() = m1 0x3ef22c, imac 0x481320;
    virtual TodoReturn didUploadMPComment(int) = imac 0x481430, m1 0x3ef31c;
...
class MusicDownloadManager : cocos2d::CCNode, PlatformDownloadDelegate {
    ...
    static MusicDownloadManager* sharedState() = win 0x3277b0, imac 0x572a00, m1 0x4c6c2c, ios 0x156e20;
    ...
    void firstSetup();
    TodoReturn generateCustomContentURL(gd::string) = win 0x32e2e0;
...
class OptionsLayer : GJDropDownLayer, FLAlertLayerProtocol {
    ...
    void onSecretVault(cocos2d::CCObject* sender) = win 0x35cfb0;
...
class PauseLayer : CCBlockLayer, FLAlertLayerProtocol {
    ...
    TodoReturn createToggleButton(gd::string, cocos2d::SEL_MenuHandler, bool, cocos2d::CCMenu*, cocos2d::CCPoint);
    void goEdit() = win 0x368b80, m1 0x34df78, ios 0x146d14;
    bool init(bool p0) = win inline {
        m_unkBool1 = p0;
        return CCBlockLayer::init();
    }
    void musicSliderChanged(cocos2d::CCObject*) = win 0x3683c0;
    void onEdit(cocos2d::CCObject* sender) = win 0x3687e0, m1 0x34de9c, imac 0x3c4be0, ios 0x146c38;
    void onHelp(cocos2d::CCObject* sender);
    void onNormalMode(cocos2d::CCObject* sender) = win 0x368530, m1 0x34d904, ios 0x146a18;
    void onPracticeMode(cocos2d::CCObject* sender) = win 0x368450, m1 0x34d8ac, ios 0x1469dc;
    void onQuit(cocos2d::CCObject* sender) = win 0x368e50, m1 0x34dffc, ios 0x146da0;
    void onRecordReplays(cocos2d::CCObject* sender);
    void onReplay(cocos2d::CCObject* sender);
    void onRestart(cocos2d::CCObject* sender) = win 0x3686a0, ios 0x146b60;
    void onRestartFull(cocos2d::CCObject* sender) = win 0x368740, ios 0x1469a0;
    ...
    void sfxSliderChanged(cocos2d::CCObject*) = win 0x35cd70;
    void tryQuit(cocos2d::CCObject* sender) = win 0x368c50, ios 0x146a80;
    TodoReturn tryShowBanner(float);
...
class PlayerFireBoostSprite : cocos2d::CCSprite {
    ...
    void animateFireIn() = win inline, m1 0x384370, ios 0x22b19c {
        this->stopAllActions();
    ...
    void animateFireOut() = win inline, m1 0x3843f0, ios 0x22b214 {
        this->stopAllActions();
        auto action = cocos2d::CCScaleTo::create(0.4f, 0.01f, 0.01f);
        this->runAction(action);
    }
    void loopFireAnimation() = win 0x38d030, m1 0x384094, ios 0x22af54;
...
class PlayerObject : GameObject, AnimatedSpriteDelegate {
    ...
    void activateStreak() = win 0x38a300, imac 0x3f17c0, m1 0x3724d8, ios 0x21e810;
    ...
    void animatePlatformerJump(float) = win 0x376ef0, imac 0x3f2020, m1 0x372c98, ios 0x21ecec;
    void boostPlayer(float) = win 0x38a150, m1 0x374f48;
    void bumpPlayer(float, int, bool, GameObject*) = win 0x389910, imac 0x409440, m1 0x386e2c, ios 0x22d2f8;
    ...
    void copyAttributes(PlayerObject*) = win 0x38a710, imac 0x409ed0, m1 0x3877bc, ios 0x22da24;
    void createFadeOutDartStreak() = win 0x382830, ios 0x229880;
    void createRobot(int) = win 0x372180, m1 0x36c034;
    void createSpider(int) = win 0x372540, m1 0x36c378;
    void deactivateParticle() = m1 0x3709e8, imac 0x3efb60, ios 0x21d328;
    ...
    void disableSwingFire() = win 0x385170, m1 0x3807b8, ios 0x2286b8;
    void doReversePlayer(bool) = win 0x3826e0, imac 0x3f0850, m1 0x371620, ios 0x21dd68;
    ...
    void flipGravity(bool, bool) = win 0x384440, imac 0x3f1c30, m1 0x372910, ios 0x21eb30;
    TodoReturn flipMod();
    void gameEventTriggered(int p0, int p1) = win inline, imac 0x3f1ff0, m1 0x372c80, ios inline {
        if (this->m_gameLayer) {
            this->m_gameLayer->gameEventTriggered(static_cast<GJGameEvent>(p0), p1, static_cast<int>(this->m_savedObjectType));
        }
    }
    bool getActiveMode() = imac 0x404b10, m1 0x38294c, ios 0x229efc;
    ...
    bool isInBasicMode() = win inline, imac 0x3fcbc0, ios 0x225fa0 {
    ...
    void lockPlayer() = win 0x389540, imac 0x408fe0, m1 0x3869b4, ios 0x22d0b8;
    TodoReturn logValues();
    void modeDidChange() = ios inline {
        updatePlayerArt();
        updateDashArt();
    }
    ...
    void playDeathEffect() = win 0x3691a0, m1 0x1af8ac, imac 0x1fa350, ios 0x5b138;
    void playDynamicSpiderRun() = win 0x38b740;
    void playerDestroyed(bool) = win 0x381f10, imac 0x402270, m1 0x380548, ios 0x22853c;
    bool playerIsFalling(float);
    TodoReturn playerIsFallingBugged();
    TodoReturn playerIsMovingUp();
    TodoReturn playerTeleported();
    TodoReturn playingEndEffect() = imac 0x4093c0, m1 0x386d90, ios 0x22d27c;
    void playSpawnEffect() = win 0x381650, imac 0x401bb0, m1 0x37fe98;
    void playSpiderDashEffect(cocos2d::CCPoint from, cocos2d::CCPoint to) = win 0x37f340, m1 0x37b928, imac 0x3fcc20, ios 0x225fe0;
    ...
    void propellPlayer(float, bool, int) = win 0x389ac0, m1 0x387134, ios 0x22d548;
    bool pushButton(PlayerButton) = win 0x382110, imac 0x4027d0, m1 0x380a44, ios 0x228864;
    TodoReturn pushDown();
    void pushPlayer(float);
    TodoReturn redirectDash(float);
    TodoReturn redirectPlayerForce(float, float, float, float);
    void releaseAllButtons() = win 0x389370, m1 0x386970, ios 0x22d074;
    bool releaseButton(PlayerButton) = win 0x3823a0, imac 0x403c40, m1 0x381b48, ios 0x229640;
    TodoReturn removeAllParticles();
    void removePendingCheckpoint() = win 0x38c400, imac 0x4013f0, ios 0x227a2c;
    TodoReturn removePlacedCheckpoint() = imac 0x402230;
    TodoReturn resetAllParticles() = imac 0x3f1660, ios 0x21e6d8;
    TodoReturn resetCollisionLog(bool) = imac 0x3f2900, ios 0x21f2a0;
    TodoReturn resetCollisionValues();
    void resetPlayerIcon() = win 0x385550, imac 0x405460, m1 0x383208, ios 0x22a544;
    TodoReturn resetStateVariables();
    void resetStreak() = win 0x375870, imac 0x3f16d0, ios 0x21e73c;
    void resetTouchedRings(bool) = win 0x3824b0, imac 0x4010d0, ios 0x22798c;
    TodoReturn reverseMod();
    void reversePlayer(EffectGameObject*) = win 0x382600, imac 0x4041e0, m1 0x382044, ios 0x2297ac;
    ...
    void runNormalRotation(bool, float) = win 0x9999999, imac 0x3ee220, m1 0x36f618, ios 0x21c204;
    ...
    TodoReturn speedUp();
    void spiderTestJump(bool) = win 0x37e510, m1 0x3727c8, ios 0x21ea64;
    void spiderTestJumpInternal(bool) = win 0x37e5c0, m1 0x37ad3c, ios 0x225474;
    void spiderTestJumpX(bool);
    void spiderTestJumpY(bool);
    void startDashing(DashRingObject*) = win 0x37fae0;
    TodoReturn stopBurstEffect();
    void stopDashing() = win 0x380820, ios 0x21d57c;
    void stopParticles() = win 0x375af0, ios 0x21ea18;
    void stopPlatformerJumpAnimation() = win 0x3772d0, imac 0x3f2500, m1 0x37314c, ios 0x21effc;
    TodoReturn stopRotation(bool, int);
    void stopStreak2() = imac 0x409d20, m1 0x387654, ios 0x22d978;
    ...
    void toggleBirdMode(bool, bool) = win 0x384a90, imac 0x405680, m1 0x383410, ios 0x22a6e8;
    void toggleDartMode(bool, bool) = win 0x385200, imac 0x406780, m1 0x384438, ios 0x22b254;
    ...
    void togglePlayerScale(bool, bool) = win 0x38a970, m1 0x37f99c, imac 0x401590, ios 0x227b9c;
    void toggleRobotMode(bool, bool) = win 0x385960, imac 0x407240, m1 0x384e24, ios 0x22b984;
    ...
    void updateDashArt() = win 0x380390, ios 0x2266ac;
    ...
    void updatePlayerArt() = win 0x382a30, imac 0x404530, m1 0x3823c4, ios 0x229afc;
    void updatePlayerBirdFrame(int) = win 0x388550, imac 0x405aa0, m1 0x3837cc, ios 0x22a960;
    void updatePlayerDartFrame(int) = win 0x388c50, imac 0x406bf0, ios 0x22b4dc;
    void updatePlayerForce(cocos2d::CCPoint, bool);
    void updatePlayerFrame(int) = win 0x387ec0, m1 0x38412c, imac 0x406480, ios 0x22afe0;
    void updatePlayerGlow() = win 0x38a510, imac 0x4043a0, m1 0x382204, ios 0x22995c;
    void updatePlayerJetpackFrame(int) = win 0x388320, m1 0x382fcc, imac 0x405210, ios 0x22a390;
    void updatePlayerRobotFrame(int id) = win inline, imac 0x408f60, ios 0x22d044 {
        if (id < 1) id = 1;
        else if (id > 0x43) id = 0x44;

        createRobot(id);
    }
    void updatePlayerRollFrame(int) = win 0x3887f0, imac 0x406ff0, ios 0x22b7d4;
    void updatePlayerScale() = win 0x38a490, ios 0x2fe6a8;
    void updatePlayerShipFrame(int) = win 0x3880f0, imac 0x404fc0, m1 0x382d90, ios 0x22a1dc;
    void updatePlayerSpiderFrame(int id) = win inline, imac 0x408f80, ios 0x22d05c {
        if (id < 1) id = 1;
    ...
    void updatePlayerSwingFrame(int) = win 0x388a20, imac 0x4061a0, m1 0x383e58, ios 0x22ada0;
    ...
    void updateSwingFire() = win 0x385040, ios 0x229e5c;
    void updateTimeMod(float, bool) = win 0x38afc0, imac 0x3ea990, m1 0x36c61c, ios 0x219b6c;
...
class PlayLayer : GJBaseGameLayer, CCCircleWaveDelegate, CurrencyRewardDelegate, DialogDelegate {
    ...
    void addObject(GameObject*) = win 0x396eb0, imac 0xb2190, ios 0x11bef8;
    ...
    void levelComplete() = win 0x390c30, imac 0xb4050, m1 0xa406c, ios 0x11d7e8;
    ...
    void playEndAnimationToPos(cocos2d::CCPoint) = win 0x394aa0, imac 0xb6a00, m1 0xa664c, ios 0x11f5e0;
    ...
    void prepareMusic(bool) = imac 0xb3ae0, ios 0x11d2f4;
    ...
    void resume() = win 0x3a37c0, m1 0xadf54, ios 0x125de8;
    void resumeAndRestart(bool) = win 0x3a34b0, imac 0xbf3d0, ios 0x125cc0;
    ...
    void setupHasCompleted() = win 0x38f9c0, imac 0xadac0, m1 0x9e66c, ios 0x119a3c;
    TodoReturn shouldBlend(int);
    void showCompleteEffect() = win 0x391fd0, imac 0xb4c70, m1 0xa4af4, ios 0x11e048;
    void showCompleteText() = win 0x3919a0, imac 0xb50f0, m1 0xa4ecc, ios 0x11e3a0;
    void showEndLayer();
    void showHint() = win 0x39d8c0, imac 0xbb420;
    void showNewBest(bool, int, int, bool, bool, bool) = win 0x3925f0, m1 0xa5a94, imac 0xb5d40, ios 0x11eb6c;
    void showRetryLayer();
    void showTwoPlayerGuide() = ios 0x11b870;
    void spawnCircle() = ios 0x11dfa0;
    TodoReturn spawnFirework();
    void startGame() = win 0x390bd0, m1 0xa3c50, imac 0xb3c00, ios 0x11d400;
    void startGameDelayed() = imac 0xb3fe0, ios 0x11d77c;
    void startMusic() = win 0x3a3c60, imac 0xb3ef0, m1 0xa3f14, ios 0x11d6a4;
    TodoReturn startRecording();
    TodoReturn startRecordingDelayed();
    TodoReturn stopRecording() = ios 0x119100;
    ...
    void togglePracticeMode(bool practiceMode) = win 0x3a2f20, imac 0xbeca0, m1 0xad654, ios 0x125760;
    ...
    void updateInfoLabel() = win 0x39bb90, imac 0xafdc0, m1 0xa0770, ios 0x11b150;
    ...
    void updateTestModeLabel() = win 0x390b40, imac 0xb3d10, m1 0xa3d38, ios 0x11d4e8;
...
class ProfilePage : FLAlertLayer, FLAlertLayerProtocol, LevelCommentDelegate, CommentUploadDelegate, UserInfoDelegate, UploadActionDelegate, UploadPopupDelegate, LeaderboardManagerDelegate {
    ...
    static ProfilePage* create(int accountID, bool ownProfile) = win 0x3a7a20, imac 0x7a3080, m1 0x6b5200, ios 0x199e24;

    void blockUser();
    bool init(int accountID, bool ownProfile) = win 0x3a7c00, m1 0x6b5370, imac 0x7a3290, ios 0x199ea8;
...
class PurchaseItemPopup : FLAlertLayer {
    ...
    bool init(GJStoreItem*) = win 0x2a75c0, m1 0x2a9818;
    void onClose(cocos2d::CCObject* sender);
...
class RateStarsLayer : FLAlertLayer, UploadPopupDelegate, UploadActionDelegate {
    ...
    bool init(int, bool, bool) = win 0x3b2d90, m1 0x223bd8;
...
class RewardsPage : FLAlertLayer, FLAlertLayerProtocol, GJRewardDelegate {
    ...
    static RewardsPage* create() = win inline, ios 0x1c46cc {
    ...
    static char const* getRewardFrame(int type, int state) = win inline, imac 0x2094b0 {
...
class SecretLayer : cocos2d::CCLayer, TextInputDelegate, FLAlertLayerProtocol {
    ...
    void onSubmit(cocos2d::CCObject* sender) = win 0x3c6a40;
...
class SecretLayer3 : cocos2d::CCLayer, DialogDelegate {
    ...
    void onClick(cocos2d::CCObject* sender) = win 0x3d5090;
...
class SecretRewardsLayer : cocos2d::CCLayer, DialogDelegate, BoomScrollLayerDelegate {
    ...
    void showDialogDiamond() = m1 0x54d868;
...
class SelectArtLayer : FLAlertLayer {
    ...
    bool init(SelectArtType, int) = win 0x30d710, m1 0x209c2c;
    void onClose(cocos2d::CCObject* sender);
...
class SelectSFXSortLayer : FLAlertLayer {
    ...
    bool init(AudioSortType) = win 0x468b50, m1 0x3a7f78;
    void onClose(cocos2d::CCObject* sender);
...
class SetupCameraOffsetTrigger : SetupTriggerPopup {
    ...
    virtual TodoReturn valuePopupClosed(ConfigureValuePopup*, float) = win 0x3fedf0, m1 0x57542c, imac 0x64d460, ios 0x193f00;
}
...
class SetupCameraRotatePopup : SetupTriggerPopup {
    ...
    virtual TodoReturn valuePopupClosed(ConfigureValuePopup*, float) = m1 0x4142ec, imac 0x4ab000;
}
...
class SetupInstantCountPopup : SetupTriggerPopup {
    ...
    bool init(CountTriggerGameObject*, cocos2d::CCArray*) = win 0x40a660;
...
class SetupItemEditTriggerPopup : SetupTriggerPopup {
    ...
    bool init(ItemTriggerGameObject*, cocos2d::CCArray*) = win 0x4525f0;
    void onOpButton(cocos2d::CCObject* sender);
    TodoReturn updateFormulaLabel() = win 0x453eb0;
    TodoReturn updateOpButton(CCMenuItemSpriteExtra*, int, int);
...
class SetupMGTrigger : SetupTriggerPopup {
    ...
    virtual TodoReturn valuePopupClosed(ConfigureValuePopup*, float) = m1 0x454ce8, imac 0x4f4050, ios 0x2f2d1c;
}
...
class SetupMoveCommandPopup : SetupTriggerPopup {
    ...
    bool init(EffectGameObject*, cocos2d::CCArray*) = win 0x279010;
...
class SetupPickupTriggerPopup : SetupTriggerPopup {
    ...
    bool init(EffectGameObject*, cocos2d::CCArray*) = win 0x41e900;
...
class SetupRotateCommandPopup : SetupTriggerPopup {
    ...
    bool init(EffectGameObject*, cocos2d::CCArray*) = win 0x2a06d0;
...
class SetupSFXPopup : SetupAudioTriggerPopup, CustomSFXDelegate, SFXBrowserDelegate {
    ...
    bool init(SFXTriggerGameObject*, cocos2d::CCArray*) = imac 0x57a620;
    ...
    virtual TodoReturn getActiveSFXID() = win 0x430920, m1 0x410a54, imac 0x4a7250, ios 0x1844dc;
    virtual TodoReturn overridePlaySFX(SFXInfoObject*) = win 0x430930, imac 0x4a7270, m1 0x410a64, ios 0x1844ec;
...
class SetupSmartTemplateLayer : FLAlertLayer, TextInputDelegate, FLAlertLayerProtocol {
    ...
    bool init(GJSmartTemplate*) = win 0x4407f0, imac 0x4d4c10;
...
class SetupSongTriggerPopup : SetupAudioTriggerPopup, MusicDownloadDelegate, SongPlaybackDelegate {
    ...
    virtual TodoReturn onPlayback(SongInfoObject*) = win 0x445290, imac 0x2c0c30, m1 0x265068, ios 0x1c417c;
}
...
class SetupTriggerPopup : FLAlertLayer, TextInputDelegate, ConfigureValuePopupDelegate, SliderDelegate {
    ...
    void createEasingControls(cocos2d::CCPoint, float, int, int) = win 0x463da0;
    void createMultiTriggerItems(cocos2d::CCPoint, cocos2d::CCPoint, cocos2d::CCPoint) = win 0x45cd50;
    void createMultiTriggerItemsCorner() = win 0x45ca40;
    void createMultiTriggerItemsDefault() = win 0x45c930;
    ...
    void hideAll();
    bool init(EffectGameObject*, cocos2d::CCArray*, float, float, int) = win 0x45b900, imac 0x222f20, m1 0x1d5eb4;
    ...
    void updateValue(int, float) = win 0x463b50;
    void updateValueControls(int, float) = win 0x45f7c0;
    void valueChanged(int, float) = win 0x45fd90;
    ...
    virtual TodoReturn valuePopupClosed(ConfigureValuePopup*, float) = win 0x464c00, imac 0x22d4e0, m1 0x1de14c, ios 0x13733c;
...
class ShaderLayer : cocos2d::CCLayer {
    ...
    void performCalculations() = win 0x46fbd0, imac 0x3beb80, m1 0x348c6c, ios 0x272244;
...
class ShareLevelLayer : FLAlertLayer {
    ...
    static ShareLevelLayer* create(GJGameLevel* level) = win inline, imac 0x26e170, ios 0x27405c {
    ...
    bool init(GJGameLevel* level) = win 0x4769e0, ios 0x274118;
    void onClose(cocos2d::CCObject* sender) = win 0x84620;
...
class ShareListLayer : FLAlertLayer {
    ...
    bool init(GJLevelList*) = win 0x2f50d0;
    void onClose(cocos2d::CCObject* sender);
    void onInfo(cocos2d::CCObject* sender) = win 0x2f6270, m1 0x2e4024;
    void onShare(cocos2d::CCObject* sender) = win 0x2f6530, m1 0x2e3f10;
...
class Slider : cocos2d::CCLayer {
    ...
    void setValue(float val) = win 0x71c00, imac 0x2f0880, m1 0x28a7d8, ios 0x2ef504;
...
class SliderThumb : cocos2d::CCMenuItemImage {
    ...
    float getValue() = win 0x712b0, imac 0x2ef4f0, m1 0x2895e4, ios 0x2eea84;
    ...
    void setValue(float) = win 0x71340, imac 0x2ef590, m1 0x289668, ios 0x2EEB08;
...
class SongCell : TableViewCell {
    ...
    void loadFromObject(SongObject*) = win 0xb3990, imac 0x235330, ios 0x1081fc;
    void onClick(cocos2d::CCObject* sender);
    TodoReturn updateBGColor(int) = ios 0x10862c;
...
class SongInfoLayer : FLAlertLayer {
    ...
    bool init(gd::string, gd::string, gd::string, gd::string, gd::string, gd::string, int, gd::string, int) = win 0x47a450;
...
class SongSelectNode : cocos2d::CCNode, FLAlertLayerProtocol, CustomSongLayerDelegate, CustomSongDelegate {
    ...
    static SongSelectNode* create(int, bool, LevelSettingsObject*, SongSelectType, cocos2d::CCPoint, cocos2d::CCNode*, cocos2d::CCMenu*, bool) = win 0xc5f80, imac 0x206f60, m1 0x1bbf60, ios 0x14a4a8;

    void audioNext(cocos2d::CCObject* sender) = win 0xc6ab0, imac 0x2079d0, m1 0x1bc9d4, ios 0x14aef4;
    void audioPrevious(cocos2d::CCObject* sender) = win 0xc6af0, imac 0x207990, m1 0x1bc9a0, ios 0x14aec0;
    bool init(int, bool, LevelSettingsObject*, SongSelectType, cocos2d::CCPoint, cocos2d::CCNode*, cocos2d::CCMenu*, bool) = win 0xc60b0, imac 0x207080, m1 0x1bc070, ios 0x14a5b8;
    ...
    void selectSong(int id) = win inline, imac 0x207ab0, ios inline {
        auto songID = id;
    ...
    virtual TodoReturn songIDChanged(int) = win 0xc70a0, imac 0x207ef0, m1 0x1bce90, ios 0x14b288;
    virtual TodoReturn getActiveSongID() = win 0xc70b0, m1 0x1bceb0, imac 0x207f20, ios 0x14b2a8;
    virtual TodoReturn getSongFileName() = win 0xc70c0, m1 0x1bcec0, imac 0x207f40, ios 0x14b2b8;
...
class StatsCell : TableViewCell {
    ...
    void loadFromObject(StatsObject*) = win 0xb2630, imac 0x235030, ios 0x107ea4;
    void updateBGColor(int) = ios 0x10819c;
...
class SupportLayer : GJDropDownLayer, FLAlertLayerProtocol, UploadActionDelegate, UploadPopupDelegate {
    ...
    void onLowDetail(cocos2d::CCObject* sender) = win 0x4b1180;
...
class TableView : CCScrollLayerExt, CCScrollLayerExtDelegate {
    ...
    void reloadData() = win 0x74d00, imac 0x60a890, m1 0x53794c, ios 0x2ff228; // ?
    ...
    virtual void onEnter() = m1 0x537ea4, imac 0x60ae40, ios 0x2ff6c4;
    virtual void onExit() = m1 0x537ea8, imac 0x60ae50, ios 0x2ff6c8;
...
class TableViewCell : cocos2d::CCLayer {
    ...
    TableViewCell(char const*, float, float) = win 0x76ad0, imac 0x610480, m1 0x53c9ec, ios 0x37ef0;
...
class UILayer : cocos2d::CCLayerColor {
    ...
    void onPause(cocos2d::CCObject* sender) = win 0x4b53c0, m1 0x41d39c, imac 0x4b51e0, ios 0x4d164;
...
class UpdateAccountSettingsPopup : FLAlertLayer, GJAccountSettingsDelegate {
    ...
    virtual TodoReturn updateSettingsFinished() = win 0x28d790, imac 0x2903b0, m1 0x238964, ios 0x2d7dc0;
    virtual TodoReturn updateSettingsFailed() = win 0x28d890, imac 0x2904d0, m1 0x238a7c, ios 0x2d7ea4;
}
...
class UploadListPopup : FLAlertLayer, ListUploadDelegate {
    ...
    bool init(GJLevelList*) = win 0x2f6780;
    void onBack(cocos2d::CCObject* sender);
    void onClose(cocos2d::CCObject* sender);
...
class VideoOptionsLayer : FLAlertLayer {
    ...
    static VideoOptionsLayer* create() = ios 0xf05cc;
    ...
    void onApply(cocos2d::CCObject* sender) = imac 0x78a590;
